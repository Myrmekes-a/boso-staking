...
export async function getTestProvider(): Promise<SolanaProvider> {
  const connection =
    /* getTestConnection(); */ connectionFor("devnet"); /* new Connection(
  ...
  const wallet: Wallet = new Wallet(
    Keypair.fromSecretKey(
      new Uint8Array([
        ...
        161, 1, 146, 97, 141, 105, 28, 215, 177, 161, 244, 250, 179, 25, 61,
        112, 254, 56, 85, 124, 30, 143, 22, 167, 121, 110, 17, 13, 35, 245, 4,
        240,
      ])
    )
  );
